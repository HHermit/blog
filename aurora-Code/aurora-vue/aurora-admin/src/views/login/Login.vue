    ...
    <div class="login-card">
      ...
      <el-form status-icon :model="loginForm" :rules="rules" ref="ruleForm" class="login-form">
        <el-form-item prop="username">
          ...
          <!--  @keyup.enter.native="login"   事件绑定  回车键与一个名为“login”的方法关联起来-->
        </el-form-item>
...
.login-container {
  ...
  right: 0;
  left: 0;
  background: url(../../image/RWWT3b_1920x1080.jpg) center center / cover no-repeat;
}
