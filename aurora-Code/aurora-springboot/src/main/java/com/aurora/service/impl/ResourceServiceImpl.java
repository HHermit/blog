...
public class ResourceServiceImpl extends ServiceImpl<ResourceMapper, Resource> implements ResourceService {
    ...
    public void importSwagger() {
        ...
        // 遍历API文档中的标签，为每个标签创建资源并添加到资源列表中
        //先把主模块添加到资源列表中
    ...
    * @Description: 获得父级资源
    * @Param: [resourceList]
    * @return: java.util.List<com.aurora.entity.Resource>
    */
    ...
    * @Description: 获得子级资源
    * @Param: [resourceList]
    * @return: java.util.Map<java.lang.Integer,java.util.List<com.aurora.entity.Resource>>
    */
